      ...
      <div className="flex flex-wrap -m-4 mb-[180px]">
        <div className="lg:w-1/3 sm:w-1/2 p-4">
          <div className="flex relative">
            <img alt="gallery" className="absolute inset-0 w-full h-full object-cover object-center" src="https://images.pexels.com/photos/5589835/pexels-photo-5589835.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
              <h2 className="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">HOT</h2>
              <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Fresh Out The Oven</h1>
              <p className="leading-relaxed">Check out our featured hot items fresh out the oven</p>
            </div>
          </div>
        </div>
        <div className="lg:w-1/3 sm:w-1/2 p-4">
