  ...
  return (
    ...
    <div class="container px-5 py-12 mx-auto">
      <div class="flex flex-col text-center w-full mb-10">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Our Featured Items</h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Check out a few of our tastiest treats below</p>
      </div>
      <div class="flex flex-wrap -m-4">
        <div class="lg:w-1/3 sm:w-1/2 p-4">
          <div class="flex relative">
            <img alt="gallery" class="absolute inset-0 w-full h-full object-cover object-center" src="https://images.pexels.com/photos/5589835/pexels-photo-5589835.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
